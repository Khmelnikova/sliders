...
f;e.wrapAll('<div class="fp-slidesContainer" />');e.parent().wrap('<div class="fp-slides" />');c(this).find(".fp-slidesContainer").css("width",a+"%");1<f&&(d.controlArrows&&La(c(this)),d.slidesNavigation&&Ua(c(this),f));e.each(function(a){d.verticalCentered&&Ca(c(this))});b=b.find(".fp-slide.active");b.length?ba(b):e.eq(0).addClass("active")}else d.verticalCentered&&Ca(c(this))}).promise().done(function(){e.setAutoScrolling(d.autoScrolling,"internal");var a=c(".fp-section.active").find(".fp-slide.active");
